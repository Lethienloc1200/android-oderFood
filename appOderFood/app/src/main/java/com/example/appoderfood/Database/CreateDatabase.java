package com.example.appoderfood.Database;
...
public class CreateDatabase extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        String tbNHANVIEN = "CREATE TABLE " + TB_NHANVIEN + " ( " + TB_NHANVIEN_MANV + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                ...
                + TB_NHANVIEN_NGAYSINH + " TEXT, " + TB_NHANVIEN_MAQUYEN + " INTEGER )";
        ...
        String tbMONAN ="CREATE TABLE "+TB_MONAN+"("+TB_MONAN_MAMON+" INTEGER PRIMARY KEY AUTOINCREMENT, "
                +TB_MONAN_TENMONAN+" TEXT,"+TB_MONAN_MALOAI+" INTEGER, "+TB_MONAN_GIATIEN+" TEXT, "+TB_MONAN_HINHANH+" TEXT )";
